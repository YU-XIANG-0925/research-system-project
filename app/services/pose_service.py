...
def convert_to_robot_motors(human_angles):
    ...
    motor_angles["MOTOR_RIGHT_SHOULDER_Y"] = -(
        170 - human_angles.get("angleYRightSW", 0)
    )
        ...
        while cap.isOpened():
            ...
            if results.pose_world_landmarks:
                ...
                for landmark_name in mp_pose.PoseLandmark.__members__:
                    frame_data["landmarks"][landmark_name] = get_landmark_coords(
                        landmarks_3d, landmark_name
                    )
